...
## in this payload if the condition inside case clause is true we should receive 500 response from server if not 200 ok message is returned by trial and errors we see that administrator user's password's first letter is 'g'
